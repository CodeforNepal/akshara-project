// tux4 comment
// From [react-autocomplete](https://github.com/reactjs/react-autocomplete/blob/master/lib/Autocomplete.js)
// Since react-aucocomplete is archived, the main code is copied here
// to fix some bugs in the code.
...
class Autocomplete extends Component {
  ...
  maybeScrollItemIntoView() {
    if (this.isOpen() && this.state.highlightedIndex !== null) {
      ...
      // tux4 lib was throwing error here
      const domItemNode = findDOMNode(itemNode);
      const domMenuNode = findDOMNode(menuNode);
      if (domItemNode == null || domMenuNode == null) { return; }
      scrollIntoView(
        domItemNode,
        domMenuNode,
